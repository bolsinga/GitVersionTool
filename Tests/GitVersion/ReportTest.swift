...
struct ReportTest {
  @Test func state_noName() async throws {
    #expect(try #require(await Report(state: .invalid, name: nil)).description == "unknown")
  ...
  @Test func state_emptyName() async throws {
    #expect(try #require(await Report(state: .invalid, name: "")).description == "unknown")
  ...
  @Test func state_name() async throws {
    #expect(try #require(await Report(state: .invalid, name: "name")).description == "unknown")
    #expect(
